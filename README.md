...
The entire project can be run by opening [`game/index.html`](game/index.html) in a browser. All of the 3rd party dependencies like Babylon use a CDN so you do not need Node or a local developer environment.
